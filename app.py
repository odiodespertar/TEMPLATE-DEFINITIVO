...
<div id="fleet-sticky" class="fleet-normal">
  <div id="fleet-drag-handle">
    ...
    style="cursor:pointer; background: #5bd4c0; color: #2e3030; border: none; font-size: 12px; padding: 6px 12px; border-radius: 4px; font-weight: bold; box-shadow: 0 3px 0 #1b4b4d; transition: all 0.05s; outline: none;"
