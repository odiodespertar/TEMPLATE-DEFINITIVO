...
# --- DATOS BASE ---
u_SDE = {"Moto - 3h": [25, 25], "Car - 5h": [25, 30], "Car - 5h Extendida": [25, 30], "Car - 3h": [25, 28]}
            ...
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #696969;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        ...
                        <td rowspan="5" contenteditable="true" class="v-total-val" oninput="recalc()" style="color: #BA55D3; font-weight: bold; font-size: 18px; text-align: center; border: 1px solid #696969; padding: 5px;">0</td>
...
">
    ...
    <button class="filter-btn" onclick="filterRows(false)" 
       ...
       <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
        ...
        <tfoot>
            <tr style="background-color: #000000; color:black; font-weight:bold;">
        ...
        <tbody id="body-1">{gen_master_rows(u_PREC, 1)}</tbody>
          <tfoot>
            ...
            <tr style="background-color: #000000; color:black; font-weight:bold;">
                <td colspan="3" style="padding:6px; text-align:right;"> TOTAL CAR REAL </td>
                <td id="total-car-real-1" style="text-align:center; color:#20B2AA; font-size: 16px; font-weight: bold;"> 0 </td>
            </tr>
        </tfoot>
    </table>
</div>
