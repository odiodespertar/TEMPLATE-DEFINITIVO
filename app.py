...
<div id="panel-prioridades" style="
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
        ...
        <div>
            ...
            <ul style="padding-left: 20px; margin: 0; line-height: 1.4; font-size: 13px; color: black;">
                <li>🟢 Locales (Centros) ➤ <b>Rentals (meter una menos para que no las ponga bajas)</b>, Truck 3.5 MLP y Delivery Large van (ambas dedicadas-3 paradas), H&B (bulk), MLP y crowd.</li>
