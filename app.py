...
<div id="tabs-container" style="display: flex; gap: 5px; margin-bottom: 10px;">
    ...
    <div style="display: flex; gap: 10px; justify-content: center;">
        ...
        <div style="text-align:center;"><label style="font-size:11px; color:#e74c3c;">ALCH ND</label><br><input type="number" class="sum-input" style="width:70px; text-align:center;"></div>
