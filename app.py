...
NOMBRES_PLANES_C1_SJA1 = [
   "ACTOPAN", "CENTRO 1", "CENTRO 2", "EJA1 SP", "MISANTLA", "NAOLINCO", "PEROTE", "TEZUITLAN", "TLALTETELA", "TRAPICHE",  
   "TUZAMAPA", "XICO", "PLAN 13", "PLAN 14", "PLAN 15", "PLAN 16", "PLAN 17", "PLAN 18", "PLAN 19", "PLAN 20" 
]
        ...
        # Caso B: unidad normal o espacio vacío
            ...
            if mostrar_orh_ocup:
                ...
                <td contenteditable="true"
                    class="edit-orh"
                    oninput="recalc()"
                    style="text-align:center; border:0.2px solid #25282b; width:45px; background:#ffffff; color:#808080;">
                    0
                </td>

                <td class="orh-hora"
                    style="text-align:center; border:0.2px solid #25282b; width:60px; background:#f5f5f5; color:#808080; font-weight:bold;">
                    00:00 hs
                </td>
       ...
       <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
        <thead>
            <tr style="background: linear-gradient(180deg, #0a2e42 0%, #25282b 100%); color: white;">
                ...
                <th style="border-right: 0.5px solid #25282b; padding: 2px; font-size: 11px; color: #25282b !important; width: 40px;">%</th>
...
<tr class="fila-total">
    <td style="border:none;"></td>
    <td colspan="6" style="padding:6px; text-align:right;">
        TOTAL CAR RUTEADAS
    </td>
