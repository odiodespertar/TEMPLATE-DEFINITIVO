    ...
    for i in range(1, rango_final + 1):
        ...
        # Caso B: Es una unidad normal o espacio vacío
            ...
            <tr class="master-row" style="{st_base}">
                ...
                <td contenteditable="true" class="edit-spr-min" oninput="recalc()" style="text-align: center; border: 0.5px solid #ccc; width: 45px; background-color: #000000; color: #333;">{spr[0]}</td>
                <td contenteditable="true" class="edit-spr-max" oninput="recalc()" style="text-align: center; border: 0.5px solid #ccc; width: 45px; background-color: #ffffff; color: #333;">{spr[1]}</td>
