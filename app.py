...
def gen_poligonos(data_target=None):
    ...
    fila_inner = f'''
    <tr class="calc-row">
        <td class="u-manual-cell" style="background: #fff2e6; border: 0.6px solid #135b83; padding: 2px; width: 105px; min-width: 105px; max-width: 105px;">
            <div style="{div_flex}">
            ...
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #135b83;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        ...
                        <td class="u-manual-cell" style="background: #fff2e6; border: 0.5px solid #135b83; padding: 2px; width: 105px; min-width: 105px; max-width: 105px;">
                            <div style="{div_flex}">
                                <button style="{btn_s}" onclick="stepVal(this, -1, 'u')">-</button> 
                                <span contenteditable="true" class="u-manual" oninput="manualEdit(this)" style="{span_num_u} color: #0c3a54 !important;">0</span>
                                <button style="{btn_s}" onclick="stepVal(this, 1, 'u')">+</button>
...
">
    ...
    <button class="filter-btn" onclick="filterRows(false)" 
       ...
       <tfoot class="fila-total"> <tr class="fila-total" style="display: none !important;"> <td colspan="3" style="padding:6px; text-align:right;"> TOTAL MLP </td>
        ...
        style="cursor:pointer; background:#135b83; color: #ffffff !important; border: 1px solid #4682B4; font-size: 11px; padding: 6px 0; border-radius: 3px; font-weight: bold; box-shadow: 0 2px 0 #3d5161; transition: all 0.05s; outline: none; width: 100%; margin-bottom: 15px; display: block; -webkit-text-fill-color: #ffffff !important;">
    ❌ OCULTAR UTILERÍAS
</button>
                ...
                <div style="margin-top:10px;">
                    <span id="time-res" style="font-size: 24px; font-weight: bold; color: #4351e8; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">0h 0m</span>
                 </div>
             </div>
        </div>
    </div>
...
">
        ...
        <div style="background: #0f4563; color: white; padding: 10px; border-radius: 6px; text-align: center; font-weight: bold; margin-bottom: 10px;">📋 PLANIFICACIÓN POR POLÍGONOS</div>
...
<div style="display:flex; justify-content:space-between; color: #696969; font-weight: 800; font-size: 16px;">
