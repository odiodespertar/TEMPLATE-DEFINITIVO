...
u_PREC = {
    "SMX5 / Ext large MLP": [50, 50], 
    "SMX5 / Ext large MLP H&B": [50, 50], 
    "SMX5 / Large MLP new": [50, 50], 
    "SMX5 / Small MLP new": [50, 50], 
    "SMX5 / Large MLP": [80, 85], 
    "SMX5 / Small MLP": [80, 85], 
    "SMX5 / Car MLP": [50, 50], 
    "SMX5 / Moto 3h": [35, 37], 
    "SMX5 / Moto 7h": [35, 37], 
    "SMX5 / Small new": [35, 37], 
    ...
    "SMX5 / Small 9h": [35, 37], 
    "SMX5 / Crowd 8h": [35, 37], 
    "SMX11 / Ext large MLP": [50, 50],  # Nota el espacio al final "MLP "
    "SMX11 / Ext large MLP H&B": [50, 50], 
    "SMX11 / Large MLP new": [50, 50], 
    "SMX11 / Small MLP new": [50, 50], 
    "SMX11 / Large MLP": [80, 85], 
    "SMX11 / Small MLP": [80, 85], 
    "SMX11 / Car MLP": [50, 50], 
    "SMX11 / Moto 3h": [35, 37], 
    "SMX11 / Moto 7h": [35, 37], 
    "SMX11 / Small new": [35, 37], 
    "SMX11 / Crowd new": [35, 37], 
    "SMX11 / Crowd 5h ext": [35, 37], 
    "SMX11 / Small 5h": [35, 37], 
    "SMX11 / Crowd 5h": [35, 37], 
    "SMX11 / Crowd zon ext": [35, 37], 
    "SMX11 / Small 9h": [35, 37], 
