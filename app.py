        ...
        # Caso B: unidad normal o espacio vacío
            ...
            if mostrar_orh_ocup:
                ...
                <td contenteditable="true"
                    class="edit-orh"
                    oninput="recalc()"
                    style="text-align:center; border:0.2px solid #25282b; width:45px; background:#ffffff; color:#6495ED;">
                    0
                </td>

                <td class="orh-hora"
                    style="text-align:center; border:0.2px solid #25282b; width:60px; background:#f5f5f5; color:#6495ED; font-weight:bold;">
                    00:00 hs
                </td>
