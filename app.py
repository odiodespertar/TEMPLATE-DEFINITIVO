    ...
    for i in range(1, 11):
        ...
        <div class="poligono-bloque" style="margin-bottom:12px; box-shadow: none; border-radius: 0px; overflow: hidden; background: #ededed; border: 1.5px solid #696969;">           
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #696969;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        <td rowspan="5" contenteditable="true" style="background: #ededed; font-weight:bold; text-align:center; border: 1px solid #696969; padding: 5px; color:#333;">{nombre_final}</td>
                    ...
                    {fila_inner}{fila_inner}{fila_inner}{fila_inner}
                     <tr style="background:#ededed; height: 32px;">
                        <td colspan="3" style="text-align:center; font-weight:bold; border: 1px solid #696969; font-size: 14px; color:#333;">ESTADO:</td>
                        ...
                        <td class="p-diff" colspan="2" style="text-align: center; font-weight: bold; border: 1px solid #696969; font-size: 14px;">VACÍO</td>
                    </tr>
