            ...
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #696969;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        ...
                        <td rowspan="5" contenteditable="true" class="v-total-val" oninput="recalc()" style="color: #2E8B57; font-weight: bold; font-size: 18px; text-align: center; border: 1px solid #696969; padding: 5px;">0</td>
