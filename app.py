    ...
    for i in range(1, rango_final + 1):
        ...
        # Caso B: Es una unidad normal o espacio vacío
            ...
            <tr class="master-row" style="{st_base}">
                <td contenteditable="true" class="edit-name" oninput="recalc()" style="font-weight: bold; text-align: left; padding-left: 10px; border: 0.2px solid #A9A9A9; width: 150px; {bg_celda}">{name}</td>
                <td contenteditable="true" class="edit-spr-min" oninput="recalc()" style="text-align: center; border: 0.2px solid #A9A9A9; width: 45px; background-color: #000000 !important; color: #ffffff !important;">{spr[0]}</td>
                <td contenteditable="true" class="edit-spr-max" oninput="recalc()" style="text-align: center; border: 0.2px solid #A9A9A9; width: 45px; background-color: #000000 !important; color: #ffffff !important;">{spr[1]}</td>
                <td contenteditable="true" class="edit-orh" style="text-align: center; border-top: 0.2px solid #A9A9A9; border-bottom: 0.2px solid #A9A9A9; border-left: 0.2px solid #A9A9A9; border-right: 0.2px solid #DCDCDC; width: 45px; {bg_celda}">{ORH_FIJOS.get(name, ["480", "66"])[0]}</td>
                <td contenteditable="true" class="edit-ocup" style="text-align: center; border-top: 0.2px solid #A9A9A9; border-bottom: 0.2px solid #A9A9A9; border-left: 0.2px solid #DCDCDC; border-right: 0.2px solid #DCDCDC; width: 45px; {bg_celda}">{ORH_FIJOS.get(name, ["480", "66"])[1]}</td>
                <td contenteditable="true" class="f-stock" oninput="recalc()" style="text-align: center; border: 0.2px solid #A9A9A9; width: 55px; font-weight: bold; font-size: 13px; {bg_celda}">0</td>
                <td class="f-left" style="font-weight: bold; text-align: center; border: 0.5px solid #A9A9A9; width: 60px; font-size: 18px; {bg_celda}">0</td>
            </tr>'''
    return rows
