...
<div id="tabs-container" style="display: flex; gap: 5px; margin-bottom: 10px;">
    ...
    <div style="display: flex; gap: 10px; justify-content: center;">
        <div style="text-align:center;"><label style="font-size:9px; color:#aaa;">VOL ANTES 00:00</label><br><input type="number" class="sum-input" style="width:75px; text-align:center;"></div>
        <div style="text-align:center;"><label style="font-size:9px; color:#aaa;">VOL DESPUÉS 00:00</label><br><input type="number" class="sum-input" style="width:75px; text-align:center;"></div>
