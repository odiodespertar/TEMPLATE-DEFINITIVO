    ...
    for i in range(1, 11):
        ...
        <div class="poligono-bloque" style="margin-bottom:12px; box-shadow: none; border-radius: 0px; overflow: hidden; background: #ededed; border: 1.5px solid #135b83;">           
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #135b83;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        <td rowspan="5" contenteditable="true" style="background: #ced7db; font-weight:bold; text-align:center; border: 1px solid #135b83; padding: 5px; color:#333;">{nombre_final}</td>
       ...
       <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
        <thead>
            <tr style="background: linear-gradient(180deg, #0a2e42 0%, #135b83 100%); color: white;">
                <th style="border-right: 0.5px solid #135b83; padding: 4px 8px; font-size: 11px; color: #135b83;">UNIDAD</th>
                <th style="border-right: 0.5px solid #135b83; padding: 2px; font-size: 11px; color: #135b83; width: 45px;">SPR MIN</th>
                <th style="border-right: 0.5px solid #135b83; padding: 2px; font-size: 11px; color: #135b83; width: 45px;">SPR MAX</th>
                <th style="border-right: 0.5px solid #135b83; padding: 4px 8px; font-size: 11px; color: #135b83; width: 60px;">SCHEDULE</th>
            </tr>
        </thead>
        ...
        <div class="tools-panel">
            ...
            ">
                <button id="toggle-tools-btn" onclick="toggleTools()" 
                    style="cursor:pointer; background: #708090; color:white; border:1px solid #4682B4; font-size:11px; padding:6px 0; border-radius:3px; font-weight:bold; box-shadow: 0 3px 0 #4682B4; transition: all 0.05s; outline: none; width: 100%; margin-bottom: 15px; display: block;">
                    ❌ OCULTAR UTILERÍAS
                </button>
                ...
                <div style="margin-top:10px;">
                    <span id="time-res" style="font-size: 24px; font-weight: bold; color: #4169E1; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">0h 0m</span>
                 </div>
             </div>
        </div>
    </div>
...
<div style="display:flex; justify-content:space-between; color: #0f4563; font-weight: 800; font-size: 16px;">
...
<div style="display:flex; justify-content:space-between; color: #FFA500; font-weight: 900; font-size: 16px;">
