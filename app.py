    ...
    function recalc() {{
        ...
        document.querySelectorAll('#body-' + tabId + ' tr').forEach(row => {{
            ...
            if(sch > 0) {{
                ...
                row.style.background = "#C0C0C0"; row.style.color = "#969696";
                fs.style.background = "#C0C0C0"; 
                mi.style.background = "#C0C0C0"; mi.style.color = "#969696"; mi.style.fontWeight = "normal";
                ma.style.background = "#C0C0C0"; ma.style.color = "#969696"; ma.style.fontWeight = "normal";
            }}
