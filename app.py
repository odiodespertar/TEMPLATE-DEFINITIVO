    ...
    let isCar = name.toLowerCase().includes("car") || name.toLowerCase().includes("híbrida");
        ...
        html += `
            <div style="margin-top: 15px; padding-top: 10px; border-top: 2px solid #555 
                <div style="display:flex; justify-content:space-between; color: #ff00ff; text-shadow: 0 0 5px #ff00ff; font-weight: bold; font-size: 11px;">
                    <span>TOTAL MLP:</span> <span>${{totalNoCar}}</span>
                </div>
                <div style="display:flex; justify-content:space-between; color: #40E0D0; font-weight: bold; ont-size: 11px;">
