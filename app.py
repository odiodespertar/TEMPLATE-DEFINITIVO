...
<td contenteditable="true" class="edit-orh" style="text-align: center; border: 0.2px solid #DCDCDC; width: 45px;">{ORH_FIJOS.get(name, ["480","66"])[0]}</td>
<td contenteditable="true" class="edit-ocup" style="text-align: center; border: 0.2px solid #DCDCDC; width: 40px;">{ORH_FIJOS.get(name, ["480","66"])[1]}</td>
