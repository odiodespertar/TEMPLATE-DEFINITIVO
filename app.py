...
<td contenteditable="true" class="edit-ocup" style="text-align: center; border-top: 0.2px solid #A9A9A9; border-bottom: 0.2px solid #A9A9A9; border-left: none; border-righ: 1px solid #DCDCDC; width: 45px;">{ORH_FIJOS.get(name, ["480","66"])[0]}</td>
