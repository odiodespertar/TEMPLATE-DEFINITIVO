...
def gen_poligonos(data_target=None):
    ...
    fila_inner = f'''
    <tr class="calc-row">
        <td class="u-manual-cell" style="background: #fcead9; border: 0.6px solid #135b83; padding: 2px; width: 105px; min-width: 105px; max-width: 105px;">
            <div style="{div_flex}">
            ...
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #135b83;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        ...
                        <td class="u-manual-cell" style="background: #fcead9; border: 0.5px solid #135b83; padding: 2px; width: 105px; min-width: 105px; max-width: 105px;">
                            <div style="{div_flex}">
                                <button style="{btn_s}" onclick="stepVal(this, -1, 'u')">-</button> 
                                <span contenteditable="true" class="u-manual" oninput="manualEdit(this)" style="{span_num_u} color: #0c3a54 !important;">0</span>
                                <button style="{btn_s}" onclick="stepVal(this, 1, 'u')">+</button>
