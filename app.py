...
'''
    ...
    fila_inner = f'''
    <tr class="calc-row">
        <td class="u-manual-cell" style="background: #b8ffe9; border: 0.6px solid #25282b; padding: 2px; width: 105px; min-width: 105px; max-width: 105px;">
            <div style="{div_flex}">
...
document.querySelectorAll('#body-' + tabId + ' tr').forEach(row => {{
    ...
    if (ruteadaCell) {{
        if (ruteadasManuales > 0) {{
            ruteadaCell.style.backgroundColor = "#e8fae8"; // Color fondo usadas 
