...
#fleet-float {{
    ...
    background: linear-gradient(135deg, 
        rgba(255, 215, 157, 0.3),  /* Durazno pastel */
        rgba(251, 170, 153, 0.3),  /* rosa y durazno pastel */
        rgba(173, 216, 230, 0.3),  /* Azul cielo pastel */
        rgba(255, 255, 102, 0.3)   /* Amarillo crema pastel */
    );
...
">
    ...
    <button class="filter-btn" onclick="filterRows(false)" 
       ...
       <tfoot class="fila-total"> <tr class="fila-total" style="display: none !important;"> <td colspan="3" style="padding:6px; text-align:right;"> TOTAL MLP </td>
        ...
        style="cursor:pointer; background: #708090; color: #ffffff !important; border: 1px solid #4682B4; font-size: 11px; padding: 6px 0; border-radius: 3px; font-weight: bold; box-shadow: 0 2px 0 #3d5161; transition: all 0.05s; outline: none; width: 100%; margin-bottom: 15px; display: block; -webkit-text-fill-color: #ffffff !important;">
    ❌ OCULTAR UTILERÍAS
</button>
