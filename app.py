            ...
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #696969;">
                ...
                <tbody>
                    <tr class="calc-row"> 
                        ...
                        <td style="width: 45px; min-width: 45px; max-width: 45px; text-align: center; border: 0.5px solid #696969;"><input type="checkbox" class="ok-check" style="transform: scale(1.4); accent-color: #FF00FF; cursor: pointer;"></td>
                    </tr>
